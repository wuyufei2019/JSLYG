...
public class AQZF_SetBasicInfoEntity extends BaseEntity {
	...
	@Column(name = "account", nullable = true, columnDefinition="varchar(200)")
	@Setter
	@Getter	
	...
	@Column(name = "cbjg", nullable = true, columnDefinition="varchar(100)")
	@Setter
	@Getter
