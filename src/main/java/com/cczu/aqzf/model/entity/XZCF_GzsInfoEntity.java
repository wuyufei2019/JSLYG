...
public class XZCF_GzsInfoEntity extends BaseEntity {
	...
	@Column(name = "illegalact", nullable = true, columnDefinition="varchar(MAX)")
	@Setter
	@Getter	
	private String illegalact;//案件详情
	...
	@Setter
	@Getter	
	private String punishresult;//详情
