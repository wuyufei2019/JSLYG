...
public class XZCF_YbcfLaspEntity extends BaseEntity {
	...
	@Column(name = "cfdxlx", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String cfdxlx;// 处罚对象类型（1.公司2.个人）

	@Column(name = "cfryname", nullable = true, columnDefinition = "varchar(50)")
	@Setter
	@Getter
	private String cfryname;//处罚当事人

	@Column(name = "cfryphone", nullable = true, columnDefinition = "varchar(50)")
	@Setter
	@Getter
	private String cfryphone;//处罚人员电话

	@Column(name = "cfryage", nullable = true, columnDefinition = "varchar(20)")
	@Setter
	@Getter
	private String cfryage;//处罚人员年龄

	@Column(name = "cfrysex", nullable = true, columnDefinition = "varchar(20)")
	@Setter
	@Getter
	private String cfrysex;//处罚人员性别
	
	@Column(name = "zycllx", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String zycllx;// 自由裁量类型（1.老2.新）
	...
	@Column(name = "dsperson", nullable = true, columnDefinition = "varchar(200)")
	@Setter
	@Getter
	...
	@Setter
	@Getter
	private String casecondition;// 检查记录情况ids
	
	@Column(name = "ajjbqk", nullable = true, columnDefinition = "varchar(2000)")
	@Setter
	@Getter
	...
	@Column(name = "sgtzid", nullable = true, columnDefinition = "varchar(20)")
	@Setter
	@Getter
	private String sgtzid;// 事故记录通知id
	
	@Column(name = "fxsj", nullable = true, columnDefinition="datetime")
	@Setter
	@Getter	
	private Timestamp fxsj;//发现时间

	@Column(name = "unlaw", nullable = true, columnDefinition="varchar(2000)")
	@Setter
	@Getter
	private String unlaw;//记录违法行为
	...
	@Column(name = "fkspflag", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String fkspflag;// 是否已经罚款审批 标志 1：已填写，0未填写
	
	@Column(name = "cxflag", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String cxflag;// 是否预立案字段  标志 1：已立案，0预立案

	// 标志位
	@Column(name = "faflag", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String faflag;// 是否已经填写调查方案 标志 1：已填写，0未填写

	@Column(name = "cfspflag", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String cfspflag;// 是否已经填写处罚审批标志 1：已填写，0未填写
