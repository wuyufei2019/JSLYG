...
/**
 * @ClassName: XZCF_YbcfYlaspEntity
 * @Description: 行政处罚-一般处罚-预立案审批
 */
@Entity
@Table(name = "xzcf_ybcfylasp")
public class XZCF_YbcfYlaspEntity extends BaseEntity {
	...
	@Setter
	@Getter
	private String cxflag;// 是否撤销字段  标志 1：已撤销，0未撤销
*/	
	...
	@Column(name = "ylaflag", nullable = true, columnDefinition = "varchar(2)")
	@Setter
	@Getter
	private String ylaflag;// 标志 1：已立案，0未立案
}
