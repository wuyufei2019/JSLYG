...
public class XzcfCommonDcDao extends BaseDao<XZCF_YbcfDcbgEntity, Long> {
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "+ mapData.get("pageSize")
				+ " * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.ID DESC) AS RowNumber,a.id,a.xzcf,a.enforcer1,a.enforcer2,a.bgbh,a.casename,a.qyname,a.unlaw,a.researchdate,a.cfryname,b.cfdxlx from xzcf_ybcfdcbg a "
	...
	public String content(Map<String, Object> mapData) {
		...
		if (mapData.get("bh") != null && mapData.get("bh") != "") {
			content = content + " AND a.bgbh like '%" + mapData.get("bh")+ "%'";
		}
		if (mapData.get("apptj") != null && mapData.get("apptj") != "") {
			content = content + " AND (a.qyname like '%" + mapData.get("apptj")+ "%' OR a.bgbh like '%" + mapData.get("apptj")+ "%')";
		}
		return content;
	}
