...
public class XzcfCommonLaspDaoImpl extends BaseDao<XZCF_YbcfLaspEntity, Long>
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "
				...
				+ " * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.ID DESC)  AS RowNumber,a.id,a.ayname,a.casesource,a" +
				".filldate,a.dsperson,a.number,a.gzflag,a.tzflag,a.cfjdflag,a.xwflag,a.cbflag,a.dcflag,a.cgflag,a" +
				".qzflag,a.jaflag,a.tempflag,a.sbflag,a.tlflag,a.fkspflag,a.cxflag,a.cfryname,a.faflag,a.cfspflag " +
				"from xzcf_ybcflasp a left join bis_enterprise b on a.id1=b.id left join t_user u on a.userid = u.id where a.s3=0 and b.s3=0 "
				+ content
				+ " ) "
	...
	public XZCF_YbcfLaspEntity findInfoById(long id) {
		// TODO Auto-generated method stub
		String sql = " SELECT  * FROM  xzcf_ybcflasp WHERE ID=" + id;
	...
	public String content(Map<String, Object> mapData) {
		...
		if (mapData.get("apptj") != null && mapData.get("apptj") != "") {
			content = content + " AND (a.number like '%" + mapData.get("apptj")+ "%' OR a.dsperson like '%" + mapData.get("apptj")+ "%')";
		}
		if (mapData.get("type") != null && mapData.get("type") != "") {
			content = content + " AND a.cxflag = '" + mapData.get("type")+ "' ";
		}
		return content;
	}
	...
	public List<Map<String, Object>> getExport(Map<String, Object> mapData) {
		String content=content(mapData);
		String sql="SELECT a.id,a.ayname,a.casesource,convert(varchar(10),a.filldate,120) lasj,a.dsperson,a.number,a.gzflag,a.tzflag,a.cfjdflag,a.xwflag,a.cbflag,a.dcflag,a.cgflag,a.qzflag,a.jaflag,a.tempflag,a.sbflag,a.tlflag,a.fkspflag,a.cxflag,a.cfryname "
				+ "from xzcf_ybcflasp a left join bis_enterprise b on a.id1=b.id left join t_user u on a.userid = u.id where a.s3=0 and b.s3=0 "
				+ content+" ORDER BY a.ID DESC";
		List<Map<String, Object>> list=findBySql(sql, null,Map.class);
		return list;
	}
}
