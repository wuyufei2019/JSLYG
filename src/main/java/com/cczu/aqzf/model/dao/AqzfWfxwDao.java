...
public class AqzfWfxwDao extends BaseDao<AQZF_WfxwEntity, Long> {
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = "SELECT TOP " + mapData.get("pageSize") + "a.* FROM ("+
		           "SELECT ROW_NUMBER() OVER(order by a.m6) rownum, a.* FROM aqzf_wfxw a WHERE a.s3 = 0 "+content +") a "+
	...
	public List<Map<String, Object>> gettextjson() {
		String sql="SELECT DISTINCT m6 text FROM aqzf_wfxw";
		List<Map<String, Object>> list=findBySql(sql, null,Map.class); 
		return list;
	}
	...
	public List<Map<String, Object>> getWfxwIdlist(Map<String, Object> mapData) {
		...
		String sql="SELECT a.id as id,a.m1 as text FROM aqzf_wfxw a WHERE a.s3 = 0 " + content + " order by a.m1";
		List<Map<String, Object>> list=findBySql(sql, null,Map.class); 
		return list;
	}
}
