...
import com.cczu.aqzf.model.entity.AQZF_Plan_EnterpriseEntity;
import com.cczu.aqzf.model.entity.AQZF_SafetyCheckRecordEntity;
import com.cczu.aqzf.model.entity.AQZF_SafetyCheckSchemeEntity;
...
public class AqzfJcfaDao extends BaseDao<AQZF_SafetyCheckSchemeEntity, Long> {
     ...
     * @param id
     */
    public void deleteByape(AQZF_Plan_EnterpriseEntity ape) {
        String sql = " UPDATE aqzf_safetycheckscheme SET S3=1 WHERE id1=" + ape.getID1() + " and id2=" + ape.getID2();
        updateBySql(sql);
    }
     ...
     * @return
     */
    public AQZF_SafetyCheckSchemeEntity findJcfaByjhqyid(String id1, String id2) {
        String sql = "SELECT a.* FROM aqzf_safetycheckscheme a where a.id1= " + id1 + " and a.id2=" + id2 + " and a.s3=0";
        List<AQZF_SafetyCheckSchemeEntity> list = findBySql(sql, null, AQZF_SafetyCheckSchemeEntity.class);
        if (list.size() < 1) {
            return null;
        }
