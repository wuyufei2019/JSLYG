...
import com.cczu.aqzf.model.dao.IXzcfCfjdDao;
...
public class XzcfCfjdDaoImpl extends BaseDao<XZCF_CfjdInfoEntity, Long>
	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT TOP "+ mapData.get("pageSize")
				+ " * FROM (SELECT ROW_NUMBER() OVER (ORDER BY b.id DESC) AS RowNumber,a.id,a.number,a.xzcf,a.percomflag,a.punishname,a.illegalactandevidence,a.punishdate,b.jaflag,b.cgflag from xzcf_cfjd a "
...
//		}
		...
		if (mapData.get("apptj") != null && mapData.get("apptj") != "") {
			content = content + " AND (a.punishname like '%"+ mapData.get("apptj") + "%' OR a.number like '%" + mapData.get("apptj")+ "%')";
		}
		return content;
	}
