...
public interface IAqzfJcjhDao {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getsjsc(Map<String, Object> map);
     ...
     * @return
     */
	public List<Map<String, Object>> findAlllist(Map<String, Object> mapData);
	 ...
	 * @return
	 */
	public List<Map<String, Object>> qydgsj(Map<String, Object> map);
}
