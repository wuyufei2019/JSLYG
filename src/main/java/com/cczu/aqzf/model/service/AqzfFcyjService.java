...
public class AqzfFcyjService {
	...
	public Map<String, Object> getAjWord(long id){
		...
		//责令整改编号
		map.put("m3",mapret.get("m3")==null||mapret.get("m3").toString().equals("")?"（ ）应急____〔  〕（ ）号":mapret.get("m3").toString());
