...
import com.cczu.aqzf.model.dao.impl.AqzfJcbkDaoImpl;
import com.cczu.aqzf.model.dao.impl.AqzfJcdyDaoImpl;
...
public class AqzfJcfaService {
	...
	//根据检查方案id获取检查内容 app
	public List<Map<String, Object>> getJcnrForApp(Long id){
		...
		for(int i=0;i<jcnrids.length;i++){
			Map<String, Object> jcbk = AqzfJcbkDao.findInfoByIdForApp(Long.parseLong(jcnrids[i]));
			list.add(jcbk);
		}
		return list;
	}
	...
	public AQZF_SafetyCheckSchemeEntity findJcfaByjhqyid(String id1, String id2) {
		return aqzfJcfaDao.findJcfaByjhqyid(id1,id2);
	}
