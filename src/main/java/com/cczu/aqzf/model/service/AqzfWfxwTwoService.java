...
import com.cczu.aqzf.model.dao.AqzfWfxwTwoDao;
...
@Service("AqzfWfxwTwoService")
public class AqzfWfxwTwoService {

	@Resource
	private AqzfWfxwTwoDao aqzfWfxwTwoDao;
	@Resource
	...
	public Map<String, Object> dataGrid(Map<String, Object> mapData) {
		List<Map<String, Object>> list=aqzfWfxwTwoDao.dataGrid(mapData);
		int getTotalCount=aqzfWfxwTwoDao.getTotalCount(mapData);
	 ...
	 * @return
	 */
	public AQZF_WfxwTwoEntity findById(Long id) {
		return aqzfWfxwTwoDao.findInfoById(id);
	}
	...
	public void updateInfo(AQZF_WfxwTwoEntity wfxw) {
		wfxw.setS2(new Timestamp(System.currentTimeMillis()));
		wfxw.setS3(0);
		aqzfWfxwTwoDao.updateInfo(wfxw);
	}
	...
	public void exportExcel(HttpServletResponse response, Map<String, Object> mapData) {
		...
		List<Map<String, Object>> list=aqzfWfxwTwoDao.getExport(mapData);
	...
	public List<Map<String, Object>> getWfxwIdlist() {
		return aqzfWfxwTwoDao.getWfxwIdlist();
	}
	...
	public List<Map<String, Object>> getWfxwIdlistForH5(Map<String, Object> map) {
		return aqzfWfxwTwoDao.getWfxwIdlist(map);
	}
	...
	public String gettextjson() {
		List<Map<String, Object>> list = aqzfWfxwTwoDao.gettextjson();
            ...
            if(count>5){
	            ...
	            for(int i = 5; i < count;i++){  
	                try {
	                	...
	                	AQZF_WfxwTwoEntity wfxw = new AQZF_WfxwTwoEntity();
		                wfxw.setS1(new Timestamp(System.currentTimeMillis()));
						wfxw.setS2(new Timestamp(System.currentTimeMillis()));
						wfxw.setS3(0);
