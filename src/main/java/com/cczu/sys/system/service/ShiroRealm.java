...
//				session.setAttribute("logoimg","/static/model/main/images/logo.png");
            ...
            ShiroUser shiroUser = new ShiroUser(user.getId(), user.getLoginName(), user.getName(), user.getUsertype(), user.getXzqy(), roles, bar, qyid, user.getUserroleflg(), dep, user.getElecsignature());
...
//		System.out.println("设置登录次数、时间");
    ...
    public static class ShiroUser implements Serializable {
        ...
        public ShiroUser(Integer id, String loginName, String name, String usertype, String xzqy, List<Role> roles, Barrio bar, Long qyid, Integer userroleflg, Department dep, String elecsignature) {
            this.id = id;
