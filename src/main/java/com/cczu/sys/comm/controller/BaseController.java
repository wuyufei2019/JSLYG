...
//		});
	...
	public <T> Map<String, Object> getEasyUIByList(List<T> list) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("rows", list);
	...
	public  void setBaseInfo(BaseEntity baseInfo){
	...
	public Map<String, Object> getWorkFlowExecutor(HttpServletRequest request) {
		Map map = ServletUtils.getParametersStartingWith(request,WorkFlowConst.ACT_VARIABLES);
		return map;
	}
