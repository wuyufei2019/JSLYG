...
public class YhpcLsJcjlDao extends BaseDao<YHPC_InterimCheckRecordEntity, Long> {
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		String content=content(mapData);
   		...
   		String sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.m2 desc,b.m1) AS RowNumber,a.*,b.M1 qyname FROM yhpc_interimcheckrecord a "
