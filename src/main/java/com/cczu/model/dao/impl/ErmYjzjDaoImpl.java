	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		if(!"1".equals(mapData.get("usertype").toString())){
			if(mapData.get("cxtype")==null || "1".equals(mapData.get("cxtype").toString())){//安监查看安监
				sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.id,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m14,a.m15,a.m16,a.m17,a.m18,a.m19,a.m20,a.m21,a.m22,a.mark,a.m23,a.fj "
						+ " FROM erm_emergencyresexpert a "
						+ " left join t_user c on c.id=a.userid "
						+ " WHERE a.s3=0 and a.mark = 1 and a.qyid is null " + content + " ) "
						+ "as h WHERE RowNumber > "+mapData.get("pageSize")+"*("+mapData.get("pageNo")+"-1) " ;
			}else{//安监查看企业
				sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.id,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m14,a.m15,a.m16,a.m17,a.m18,a.m19,a.m20,a.m21,a.m22,a.mark,a.m23,a.fj,b.m1 as qynm FROM erm_emergencyresexpert a "
						+ " left join bis_enterprise b on a.qyid=b.id "
						+ " WHERE b.s3=0 and a.s3=0 and a.mark = 1 and a.qyid is not null " + content + " ) "
						+ "as h WHERE RowNumber > "+mapData.get("pageSize")+"*("+mapData.get("pageNo")+"-1) " ;
			}
		}else{
			sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.id,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m14,a.m15,a.m16,a.m17,a.m18,a.m19,a.m20,a.m21,a.m22,a.mark,a.m23,a.fj,b.m1 as qynm FROM erm_emergencyresexpert a"
					+ " left join bis_enterprise b on a.qyid=b.id WHERE a.s3=0 and a.mark = 1 and b.s3=0 " + content + ") "
					+ "as h WHERE RowNumber > "+mapData.get("pageSize")+"*("+mapData.get("pageNo")+"-1) " ;
		}
	...
	public int getTotalCount(Map<String, Object> mapData) {
		...
		if(!"1".equals(mapData.get("usertype").toString())){
			...
			if(mapData.get("cxtype")==null || "1".equals(mapData.get("cxtype").toString())){
				...
				sql =" SELECT COUNT(*) FROM erm_emergencyresexpert a "
						+ " left join bis_enterprise b on a.qyid=b.id "
						+ " WHERE a.s3=0 and a.mark = 1 and b.s3=0 and a.qyid is not null " + content;
			}
		}else{
			sql =" SELECT COUNT(*) FROM erm_emergencyresexpert a "
					+ " left join bis_enterprise b on a.qyid=b.id WHERE a.s3=0 and a.mark = 1 and b.s3=0 " + content;
