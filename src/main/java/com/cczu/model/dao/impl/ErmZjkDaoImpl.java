...
import com.cczu.model.dao.IErmZjkDao;
...
@Repository("ErmZjkDao")
public class ErmZjkDaoImpl extends BaseDao<ERM_EmergencyResExpertEntity,Long> implements IErmZjkDao {
	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		if(!"1".equals(mapData.get("usertype").toString())){
			if(mapData.get("cxtype")==null || "1".equals(mapData.get("cxtype").toString())){//安监查看安监
				sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.id,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m14,a.m15,a.m16,a.m17,a.m18,a.m19,a.m20,a.m21,a.m22,a.mark,a.fj,a.m23 "
				...
				sql =" SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER (ORDER BY a.id) AS RowNumber,a.id,a.m1,a.m2,a.m3,a.m4,a.m5,a.m6,a.m7,a.m8,a.m9,a.m10,a.m11,a.m12,a.m13,a.m14,a.m15,a.m16,a.m17,a.m18,a.m19,a.m20,a.m21,a.m22,a.mark,a.fj,a.m23,b.m1 as qynm FROM erm_emergencyresexpert a "
