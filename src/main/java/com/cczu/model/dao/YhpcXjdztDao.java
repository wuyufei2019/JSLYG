...
public class YhpcXjdztDao extends BaseDao<YHPC_CheckResultEntity, Long>{
	...
	public List<Map<String, Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = "SELECT a.id,a.jcdname,a.createtime,b.NAME uname,a.checkresult,a.jcdid,a.jcdtype,a.yanse,a.qyid FROM(SELECT b.checkresult,b.createtime,b.userid,b.id,a.id jcdid,a.m1 jcdname,a.id1 qyid,1 jcdtype,m9 yanse FROM fxgk_accidentrisk a "
