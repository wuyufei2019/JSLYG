...
public class PageAqpxKjkglController extends BaseController {
    ...
    public String index(Model model) {
        ...
        } else if(sessionuser.getUsertype().equals("0"))//非企业用户无法使用该模块
            return "../error/403";
        else
            return "aqpx/kjkgl/index-pub";
    }
     ...
     * @param model
     */
    @RequestMapping(value = "index-priv")
    public String indexPriv(Model model) {
        return "aqpx/kjkgl/index-priv";
    }
     ...
     * @param model
     */
    @RequestMapping(value = "index-pub")
    public String indexPub(Model model) {
        return "aqpx/kjkgl/index-pub";
    }
     ...
     */
    @RequiresPermissions("aqpx:kjgl:view")
    @RequestMapping(value = "list_pub")
    @ResponseBody
    public Map<String, Object> getDataPub(HttpServletRequest request) {

        Map<String, Object> map = getPageMap(request);
        map.put("qyid", 0);
        map.put("m1", request.getParameter("aqpx_kjgl_cx_m1_pub"));
    ...
    public String jcdchoosechoose(@RequestParam("type") String type, Model model) {
    ...
    public String create(AQPX_Courseware2Entity ac, HttpServletRequest request) {
        ...
        } else if(User.USERTYPE.ADMIN.getUsertype().equals(sessionuser.getUsertype())){
            ac.setID1(0L);//企业id
        }
