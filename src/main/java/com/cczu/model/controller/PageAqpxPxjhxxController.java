...
public class PageAqpxPxjhxxController extends BaseController {
	...
	public Map<String, Object> getData(HttpServletRequest request) {
		Map<String, Object> pageMap = getPageMap(request);
		pageMap.putAll(getAuthorityMap());


		pageMap.put("m1", request.getParameter("aqpx_pxjhxx_cx_m1"));
		pageMap.put("qyname", request.getParameter("qyname"));


        Map<String, Object> map = aqpxpjhxxService.dataGrid(pageMap);
        return map;
