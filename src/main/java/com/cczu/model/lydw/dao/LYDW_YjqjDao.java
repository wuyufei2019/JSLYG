...
public class LYDW_YjqjDao extends BaseDao<LYDW_YJQJ, Long> {
	...
	public List<Map<String,Object>> dataGrid(Map<String, Object> mapData) {
		...
		String sql = " SELECT top "+mapData.get("pageSize")+" * FROM ( SELECT ROW_NUMBER() OVER ("+ordercont+") AS RowNumber, qj.*, yg.m1, yg.m3, yg.m4, d.m1 bm, yg.m9, xb.x, xb.y, xb.z floor from lydw_yjqj qj left join lydw_emp_pubfile gk on qj.gkid=gk.fileid left join bis_employee yg on yg.id=gk.empid " +
