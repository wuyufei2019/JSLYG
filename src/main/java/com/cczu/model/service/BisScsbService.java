		...
		if (list.size() > 3) {
			...
			for (List<Object> bis : list) {
				...
				try{
					...
					scsb.setM1(bis.get(0).toString());
					scsb.setM2(bis.get(1).toString());
					scsb.setM3(bis.get(2).toString());
					scsb.setM4(bis.get(3).toString());
					scsb.setM5(bis.get(4).toString());
					scsb.setM14(bis.get(5).toString());
					if(bis.get(6).toString()!=null&&!bis.get(6).toString().equals(""))
						scsb.setM15(DateUtils.getTimestampFromStr(bis.get(6).toString()));
					scsb.setM16(bis.get(7).toString());
					...
					scsb.setM17(departId);
					scsb.setM18(bis.get(9).toString());
					scsb.setM6(bis.get(10).toString());
					scsb.setM9(bis.get(11).toString());
					if(bis.get(12).toString()!=null&&!bis.get(12).toString().equals(""))
						scsb.setM8(DateUtils.getTimestampFromStr(bis.get(12).toString()));
					if(bis.get(13).toString()!=null&&!bis.get(13).toString().equals(""))
						scsb.setM10(DateUtils.getTimestampFromStr(bis.get(13).toString()));
					scsb.setM7(bis.get(14).toString());
					scsb.setM11(bis.get(15).toString());
					scsb.setM12(bis.get(16).toString());
					scsb.setM13(bis.get(17).toString());
