...
@Service("ErmZjkService")
public class ErmZjkServiceImpl implements IErmZjkService {
	
	@Resource
	private IErmZjkDao ermZjkDao;

	@Override
	public List<ERM_EmergencyResExpertEntity> findAll() {
		return ermZjkDao.findAllInfo();
	}

	@Override
	public void addInfo(ERM_EmergencyResExpertEntity erm) {
		ermZjkDao.addInfo(erm);
		
	}

	@Override
	public void updateInfo(ERM_EmergencyResExpertEntity erm) {
		ermZjkDao.updateInfo(erm);
	}
	
	@Override
	public String content(Map<String, Object> mapData) {
		return ermZjkDao.content(mapData);
	}

	@Override
	public Map<String, Object> dataGrid(Map<String, Object> mapData) {
		
		List<Map<String, Object>> list=ermZjkDao.dataGrid(mapData);
		int getTotalCount=ermZjkDao.getTotalCount(mapData);
	...
	public void exportExcel(HttpServletResponse response, Map<String, Object> mapData) {
		if("1".equals(mapData.get("usertype").toString())){
			...
			List<Map<String, Object>> list=ermZjkDao.getExcel(mapData);
	...
	public String getqylistapp(Map<String, Object> tmap) {
		return JsonMapper.toJsonString(ermZjkDao.getqylistapp(tmap));
	}
}
