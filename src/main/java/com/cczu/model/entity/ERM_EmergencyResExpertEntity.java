...
public class ERM_EmergencyResExpertEntity extends BaseEntity {
	...
	@Column(name = "M23", nullable = true, length = 500)
	@Setter
	@Getter
	private String M23;//主要科技成果
	...
	@Setter
	@Getter
	public int mark;//用于区分是否为应急专家，0为专家，1为应急专家

	@Column(name = "fj", nullable = true, length = 500)
	@Setter
	@Getter
	private String fj;//图片附件
