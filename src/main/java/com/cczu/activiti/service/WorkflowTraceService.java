package com.cczu.activiti.service;

import com.cczu.activiti.util.WorkflowUtils;
...
public class WorkflowTraceService {
    ...
    public List<Map<String, Object>> traceProcess(String processInstanceId) throws Exception {
        ...
        if (execution != null) {
            ...
            if (property != null) {
                currentActivityId = property.toString();
            }
            ...
            for (ActivityImpl activity : activitiList) {
                String activityType = getActivityType(currentActivityId,activity.getId(),historicActivityInstanceList);

                Map<String, Object> activityImageInfo = packageSingleActivitiInfo(activity, processInstance, activityType);
            ...
            for (ActivityImpl activity : activitiList) {
                ...
                for (HistoricActivityInstance instance : activityInstances) {
                    if (instance.getActivityId().equals(id)) {
                        break;
                    }
                }
                Map<String, Object> activityImageInfo = null;
    ...
    private String getActivityType(String currentActivityId, String activityId,
                                   List<HistoricActivityInstance> historicActivityInstanceList) {

        String activitiType = "";//B：历史节点 A：正在执行节点
        // 当前节点
        if (currentActivityId.equals(activityId)) {
            activitiType = "A";
        } else {
    ...
    private void setPosition(ActivityImpl activity, Map<String, Object> activityInfo) {
        activityInfo.put("x", activity.getX() + 5);
        activityInfo.put("y", activity.getY() + 5);
    }
}
