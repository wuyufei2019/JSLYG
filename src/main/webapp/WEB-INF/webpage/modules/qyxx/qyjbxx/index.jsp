...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/qyxx/qyjbxx/index.js?v=2.3"></script>
...
<div class="easyui-panel" style="width:100%;height:100%;">
    <div class="easyui-layout" data-options="fit:true">
        <div collapsible="true" title="网格化菜单" data-options="region:'west'" style="width:20%;height:100%">
            <div id="wgcd">
            </div>
        </div>
        <div data-options="region:'center'" style="width:65%;height:100%">
            <div id="bis_index_tb" style="padding:5px;height:auto">
                <form id="bis_index_searchFrom" style="margin-bottom: 8px;" class="form-inline">
                    ...
                    <input type="text" id="check_company_name" name="check_company_name" class="easyui-combobox"
                           style="height: 30px;"
                           data-options="editable:true ,valueField: 'id',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
                    <input id="qygm" name="qygm" class="easyui-combobox" style="height: 30px;width: 100px;"
                           data-options="panelHeight:'auto',
								editable:false ,data: [
										{value:'规上',text:'规上'},
										{value:'规下',text:'规下'},
										{value:'小微',text:'小微'}],prompt: '规模情况' "/>
                    <c:if test="${userroleflg!=1&&userroleflg!=2}">
                        <input id="jglx" name="jglx" class="easyui-combobox" style="height: 30px;width: 100px;"
                               data-options="panelHeight:'auto',
								editable:false ,data:[{value:'0',text:'全部'},{value:'1',text:'工矿'},{value:'2',text:'危险化学品'},{value:'3',text:'烟花爆竹'},{value:'9',text:'其他'}],prompt: '监管分类' "/>
                    </c:if>
                    ...
                    <input type="text" name="xzqy" class="easyui-combotree" style="height: 30px;"
                           data-options="editable:false,valueField: 'id',textField: 'text',url:'${ctx}/system/admin/xzqy/xzqyjson',prompt: '网格' "/>
                    ...
                    <div class="col-sm-12">
                        <div class="pull-left">
                            ...
                            <shiro:hasPermission name="bis:qyjbxx:update">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="upd()" title="修改"><i class="fa fa-file-text-o"></i> 修改
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="bis:qyjbxx:delete">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="del()" title="删除"><i class="fa fa-trash-o"></i> 删除
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="bis:qyjbxx:view">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="view()" title="查看"><i class="fa fa-search-plus"></i> 查看
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="bis:qyjbxx:export">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="fileexport()" title="导出"><i class="fa fa-external-link"></i> 导出
                                </button>
                            </shiro:hasPermission>
                            <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left"
                                    onclick="statistics()" title="统计"><i class="fa fa-bar-chart"></i> 统计
                            </button>
                            <shiro:hasPermission name="bis:qyjbxx:comfirm">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="nodatamodule()" title="确认"><i class="fa fa-check"></i> 信息确认
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasAnyRoles name="admin,superadmin">
                                <button class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="disableBis()" title="停产"> 停产
                                </button>
                                <button class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="enableBis()" title="启用"> 恢复
                                </button>
                            </shiro:hasAnyRoles>
                            <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left"
