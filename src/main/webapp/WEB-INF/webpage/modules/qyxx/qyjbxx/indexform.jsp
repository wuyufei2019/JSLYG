...
<body>
				...
				<table
					...
					panelHeight:120,editable:false ,data: [
						...
						<tr>
							...
							<td class="width-28"><input id="M36" class="easyui-combobox" style="width:250px;height:30px;" name="M36" value="${qylist.m36 }" data-options="required:'true',panelHeight:'auto' ,data:[{value:'1',text:'工矿'},{value:'2',text:'危险化学品'},{value:'3',text:'烟花爆竹'},{value:'9',text:'其他'}]"/></td>
					...
					required:'true',panelHeight:200,editable:false ,data: [
						...
						<tr>
							...
							<td class="width-28"><input name="ID2" value="${qylist.ID2}"  class="easyui-combotree"
														style="width:250px;height: 30px;"
														data-options="required:'true',url:'${ctx}/system/admin/xzqy/xzqyjson',method: 'get',panelHeight:180"/></td>
						</tr>
						<tr>
	...
	var url="";
	// 添加修改区分
	var changeFlag= true; //查询企业变更未审核数量，设置标志位


	function setChangeFlag(){
		$.ajax("${ctx}/bis/qybg/notreview",{async:false,success:function (data) {
				if(data>0){
					layer.open({icon:4,title: '温馨提示',offset: 'rb',content: '企业变更有信息未审核，禁止变更！',shade: 0 ,time: 4000 });
					changeFlag = false;
				}else{
					changeFlag = true;
				}
