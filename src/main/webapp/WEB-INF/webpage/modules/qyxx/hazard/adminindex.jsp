...
<script type="text/javascript"
	src="${ctx}/static/model/js/qyxx/hazard/adminindex.js?v=1.7"></script>
</head>
<body>
	<div id="tb" style="padding:5px;height:auto">
		<div>
			<form id="searchFrom" class="form-inline" style="margin-bottom: 8px;">
				<input type="text" id="bis_hazard_qy_name" name="view_qyid"
				...
				<input type="text" id="bis_hazard_wuzhi_name"
					name="view_wz" class="easyui-combobox" style="height:30px;"
					data-options="editable:true ,valueField: 'id',textField: 'text',url:'${ctx}/bis/hazardIdentity/wznmlist',prompt: '辨识物质' " />
				<input type="text" id="dj" name="view_dj" class="easyui-combobox" style="height:30px;"
