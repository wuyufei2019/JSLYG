...
<head>
<title>安全文件发布</title>
<link rel="stylesheet" href="${ctx}/static/pdfview/web/viewer.css">
<link rel="resource" type="application/l10n" href="${ctx}/static/pdfview/web/locale/locale.properties">
<script type="text/javascript">
var DEFAULT_URL='${ctx}${wjfb.m14}';
</script>
				...
				<c:if test="${not empty wjfb.m6}">
					<c:set var="url" value="${fn:split(wjfb.m6, '||')}" />
						<div  style="margin-bottom: 10px;">
							...
							<img src="${ctxStatic}/model/images/w.png"><a style="color:#337ab7;text-decoration:none;cursor:pointer;margin-right:20px;" onclick="window.open('${url[0]}')">${url[1]}.doc</a>
							</c:if>
							<img src="${ctxStatic}/model/images/p.png"><a style="color:#337ab7;text-decoration:none;cursor:pointer;margin-right:20px;" onclick="window.open('${wjfb.m14}')">${url[1]}.pdf</a>
						</div>
				</c:if>
			</div>
