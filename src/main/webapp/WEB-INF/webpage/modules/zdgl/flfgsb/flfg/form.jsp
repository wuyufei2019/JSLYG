			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
			    <tr>
					...
					<td class="width-35">
					<input id="M1" name="M1" class="easyui-combotree" style="width: 100%;height: 30px;" value="${flfg.m1 }" data-options="required:'true',panelHeight:'150px',editable:false,url: '${ctx}/zdgl/flfg/treelist'" /></td>
				</tr>
				<tr >
