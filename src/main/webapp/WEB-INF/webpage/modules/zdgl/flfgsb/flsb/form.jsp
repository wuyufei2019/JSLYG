			  ...
			  <tbody>
			    <c:if test="${action eq 'create'}">
				  	<tr>
						...
						<td class="width-35"><input id="lb" name="lb" class="easyui-combotree" style="width: 100%;height: 30px;" value="${flfg.m1}" data-options="required:'true',panelHeight:'150px',editable:false,url: '${ctx}/zdgl/flfg/treelist'" /></td>
					</tr>
					<tr >
