...
<div class="easyui-panel" style="width:100%;height:100%;">
    <div class="easyui-layout" data-options="fit:true">
        <div collapsible="true" title="部门列表" data-options="region:'west'" style="width:20%;height:100%">
            <div id="department">
            </div>
        </div>
            ...
            <div id="tb" style="padding:5px;height:auto">
                <form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">
                    <div class="form-group">
                        ...
                        <span>内部角色：</span><input type="text" name="filter_LIKES_nbjs" class="easyui-combobox"
                                                 style="height: 30px;"
                                                 data-options="prompt: '',editable:false ,panelHeight:'120',
                        ...
                        <div id="operation" class="pull-left">
                            <shiro:hasPermission name="sys:user:add">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="add()"
                                        title="添加企业用户"><i class="fa fa-plus"></i> 添加企业成员
                                </button>
                            </shiro:hasPermission>
                            ...
                            <shiro:hasPermission name="system:compuser:roleUpd">
                                <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                        onclick="userForCompRole()" title="用户角色"><i class="fa fa-plus-circle"></i>
                                    修改内部角色
                                </button>
                            </shiro:hasPermission>
                            <button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left"
...
<script type="text/javascript">
    ...
    var department;
    $(function () {
        department = $('#department').treegrid({
            method: "post",
    ...
    //弹窗增加
    function add() {
        openDialog("添加用户", "${ctx}/system/user/create" , "800px", "450px", "");
    }
    ...
    function showlist(rowdata) {
        ...
        dg = $('#dg').datagrid({
            method: "get",
            url: '${ctx}/system/user/json2/'+code,
            fit: true,
            fitColumns: true,
            border: false,
            idField: 'id',
