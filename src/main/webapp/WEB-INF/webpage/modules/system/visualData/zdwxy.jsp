...
<header class="header left">
    ...
    <div class="right nav text_right">
        <ul> <li class="nav_active"><i class="nav_11"></i><a href="${ctx}/a/vd_page5">重大危险源</a> </li>
...
<div class="left car_left">
    <div class="left_up bow_shadow">
        ...
        <p ><ul id="treeDemo" class="ztree" style="overflow: scroll; height: calc(100% - 90px);"></ul></p>
    </div>
    <div class="left_down bow_shadow">
<div class="text_center"><a href="javascript:void (0)" class="tab_a tab_aActive">基本信息</a><a style="display:none" href="javascript:void (0)" class="tab_a">云台控制</a> </div>
