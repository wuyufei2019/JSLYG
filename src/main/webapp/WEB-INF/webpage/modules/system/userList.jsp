                            ...
                            <shiro:hasPermission name="sys:user:add">
                                <shiro:hasAnyRoles name="admin,spueradmin">
                                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                            onclick="add()" title="添加"><i class="fa fa-plus"></i> 添加用户
                                    </button>
                                </shiro:hasAnyRoles>
                                <shiro:hasAnyRoles name="ajcountyadmin">
                                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                            onclick="add()" title="添加企业管理员账号"><i class="fa fa-plus"></i> 添加企业管理员账号
                                    </button>
                                </shiro:hasAnyRoles>
                                <shiro:hasAnyRoles name="companyadmin">
                                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                                            onclick="add()" title="添加企业普通用户"><i class="fa fa-plus"></i> 添加企业成员
                                    </button>
                                </shiro:hasAnyRoles>
                            </shiro:hasPermission>
...
<script type="text/javascript">
    ...
    //弹窗增加
    function add() {
        openDialog("添加用户", "${ctx}/system/user/create" , "800px", "500px", "");
    }
    ...
    function showlist(rowdata) {
        ...
        dg = $('#dg').datagrid({
            method: "get",
            url: '${ctx}/system/user/json?xzqy=' + code,
            fit: true,
            fitColumns: true,
            border: false,
            idField: 'id',
