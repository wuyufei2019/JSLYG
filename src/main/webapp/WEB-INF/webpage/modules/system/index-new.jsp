...
<%
    String logotitle = " ";
    String logoimg = "/model/images/login/logo_qy.png";
...
<div id="container">
    <div id="hd">
        <div class="hd-top">
            <h1 class="logo">
                <img id="comLogo" class="comLogo" src="${ctxStatic}/<%=logoimg %>"
                     onmouseover="layer.tips('点击logo可以修改哦！', '#comLogo',{time: 2000} );" onclick="updQyLogo()"/>
                <!-- onclick="updQyLogo()" -->
            ...
            <div class="setting ue-clear">
                ...
                <ul class="setting-main ue-clear">
                    <li style="width: 60px"><a href="${ctxStatic}/app/JSLYG.apk">下载APP</a></li>
            ...
            <div class="user-info">
                <a href="javascript:;" onclick="openDialog('个人信息设置','${ctx}/system/user/infor')" title="个人档案"
                   class="user-avatar"><span></span></a>
    ...
    <div id="bd">
        <div class="sidebar">
            ...
            <ul class="nav2">
                <li class="subnav-li" href="${ctx}/a/home" data-id="1"><a href="javascript:;" class="ue-clear"><i
    ...
    <div id="ft" class="ue-clear">
        ...
        <div class="ft2 ue-clear">
            <span>中安联科</span>
            <em id="project_version" onclick="openDialog('更新日志','${ctx}system/xmversion/showhis')"
                style="padding-left: 10px;cursor: pointer;"> </em>
            <i class="ft-icon2"></i>
        </div>
    </div>
</div>
<div class="opt-panel skin-opt" style="top:37px;right:200px;display: none;">
    <ul class="ue-clear">
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=dxj')">待巡检<span class="num"
                                                                                                            id="dxj">(0)</span></a>
        </li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=dsh')">待审核<span class="num"
                                                                                                            id="dsh">(0)</span></a>
        </li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=dsp')">待审批<span class="num"
                                                                                                            id="dsp">(0)</span></a>
        </li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=djc')">待检查<span class="num"
                                                                                                            id="djc">(0)</span></a>
        </li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=xwj')">新文件<span class="num"
                                                                                                            id="xwj">(0)</span></a>
        </li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=pxtz')">培训通知<span
                class="num" id="pxtz">(0)</span></a></li>
        <li><a class="text" onclick="openDialog('消息查看','${ctx}/system/message/index?msgtype=dcwj')">调查问卷<span
                class="num" id="dcwj">(0)</span></a></li>
    </ul>
</div>
