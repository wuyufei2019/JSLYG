...
<link href="${ctx}/static/model/css/login/login.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/static/model/css/css_ror/base.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/static/model/css/css_ror/zhengfu.css" rel="stylesheet" type="text/css" />
<script>
	var ctx="${ctx}";
//执行键盘按键命令
function keyDown(e){ 
...
<body onload="openwin();" onkeydown="keyDown(event);" style="min-width: 1200px;">
    ...
    <div class="bgbox" id="bgbox"
		 style="clear: both;background-image:url('${ctx}/static/model/images/login/loginbg.jpg');display: flex">
		<div class="section3">
			<div class="u_fr">
				<div class="ui_base u_p3d">
					...
					<div class="base u_p3d">
						<div class="ball_base u_p3d ball_1">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/1.png" alt="">
							</div>
						</div>
						<div class="ball_base u_p3d ball_2">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/2.png" alt="">
							</div>
						</div>
						<div class="ball_base u_p3d ball_3">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/3.png" alt="">
							</div>
						</div>
						<div class="ball_base u_p3d ball_4">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/4.png" alt="">
							</div>
						</div>
						<div class="ball_base u_p3d ball_5">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/5.png" alt="">
							</div>
						</div>
						<div class="ball_base u_p3d ball_6">
							<div class="ball">
								<img src="${ctx}/static/model/images/index/6.png" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box">
    		<div class="loginbox" style="margin: 40px 20% 0 60px;">
