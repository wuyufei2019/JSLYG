...
<div id="target_mbzp_tb" style="padding:5px;height:30px">
	...
	<input name="finishtime" class="easyui-datetimebox"  style="height: 30px;width:120px;" data-options="editable:false,prompt: '结束时间'" />
...
function searchShow(){
    ...
    if(obj.starttime==""||obj.finishtime==""||obj.ygid==""){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(showdata.length>0){
                    ...
                    // 向 线路数组中事先添加站位元素
                    naviResults[0].groupId = showdata[0].z;
...
function trackTo(coord) {
	im.moveTo({
		...
		update:function(thisMarker) {
			...
			console.log("naviResults[0].groupId "+naviResults[0].groupId);
