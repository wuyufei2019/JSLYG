			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<td class="width-30">
                        <input style="width: 100%;height: 30px;" id="M9" name="M9" value="${dhzy.m9 }" class="easyui-combobox"  data-options="valueField: 'text', textField: 'text',multiple:true, editable:true ,validType:['length[0,250]']" />
                    </td>
				</tr>
