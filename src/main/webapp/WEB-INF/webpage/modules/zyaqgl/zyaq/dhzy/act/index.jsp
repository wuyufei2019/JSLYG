		...
		<span id="divper">
			...
			<shiro:hasPermission name="zyaqgl:dhzy:delete">
                ...
                <shiro:hasPermission name="zyaqgl:dhzy:viewzt">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="viewzt()"
                            title="查看状态"><i class="fa fa-star-o"></i> 查看状态
                    </button>
                </shiro:hasPermission>
                <shiro:hasPermission name="zyaqgl:dhzy:export">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                            onclick="fileexport()" title="导出Excel"><i class="fa fa-external-link"></i> 导出Excel
                    </button>
                </shiro:hasPermission>
                <shiro:hasPermission name="zyaqgl:dhzy:export">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                ...
                <shiro:hasPermission name="zyaqgl:dhzy:gb">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="gb()"
                            title="关闭"><i class="fa fa-times-circle"></i> 关闭
                    </button>
                </shiro:hasPermission>
                <span id="divper2">
			</span>
