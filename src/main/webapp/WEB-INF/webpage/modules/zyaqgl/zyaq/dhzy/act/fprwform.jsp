    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td class="width-30"><input name="M15" style="width: 100%;height: 30px;" id="M15"
                                        ...
                                        data-options="panelHeight:'100',required:'true',valueField: 'text',textField: 'text'"/>
            </td>
        ...
        <tr>
            <td class="width-20 active"><label class="pull-right">生产单位负责人：</label></td>
        ...
        <tr>
            <td class="width-20 active"><label class="pull-right">动火初审人：</label></td>
...
<script type="text/javascript">
    ...
    $(function () {
        $.post('${ctx}/system/compuser/userjson', function (data) {
            data = eval(data);
