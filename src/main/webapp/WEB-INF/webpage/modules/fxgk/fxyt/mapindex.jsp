...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxyt/mapindex.js?v=1.5"></script>
    ...
    <div class="easyui-tabs" fit="true">
        <div title="风险点分布图" style="height:100%;" data-options="" id="">
            <div id="r-result" style="margin:10px auto;">
                &nbsp;&nbsp;
                <input id="keyword" type="text" class="easyui-textbox" style="width:150px;height: 30px;" value=""
...
<c:if test="${type == '1'}">
    <div class="easyui-tabs" fit="true">
        <div title="风险点分布图" style="height:100%;" data-options="" id="">
            ...
            <div style="height:100%;width:100%;position:absolute;" id="dituContent"><img style="width:100%"
                                                                                         id="img1"></img></div>
        </div>
        <div title="风险平面图" style="height:100%;" data-options="" id="">
            <div style="height:100%;width:100%;position:absolute;" id="dituContent2"><img style="width:100%"
                                                                                          id="img2"></img></div>
        </div>
    </div>
</c:if>
