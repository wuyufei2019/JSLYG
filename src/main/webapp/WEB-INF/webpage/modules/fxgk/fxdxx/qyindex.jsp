...
<div id="fxgk_fxxx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		<!-- <input type="text" id="fxgk_fxxx_qyname" name="fxgk_fxxx_qyname" class="easyui-textbox" style="height: 30px;" data-options="prompt: '企业名称'" /> -->
	<!-- 	<input type="text" name="province" class="easyui-combobox" style="height: 30px;" data-options="prompt: '镇区名称'" /> -->
		...
		<input type="text" id="fxgk_fxxx_fxfj"name="fxgk_fxxx_fxfj" class="easyui-combobox" style="height: 30px;" data-options="prompt: '风险分级'
