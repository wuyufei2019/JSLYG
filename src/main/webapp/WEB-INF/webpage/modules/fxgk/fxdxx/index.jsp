...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/fxgk/fxdxx/index.js?v=1.9"></script>
...
<div id="fxgk_fxxx_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		...
		<c:if test="${usertype != '1' }">
			<input type="text"  name="fxgk_fxxx_xzqy" class="easyui-combotree" style="height: 30px;" data-options="editable:false,valueField: 'id',textField: 'text',url:'${ctx}/system/admin/xzqy/xzqyjson',prompt: '网格' "/>  	
		</c:if>
