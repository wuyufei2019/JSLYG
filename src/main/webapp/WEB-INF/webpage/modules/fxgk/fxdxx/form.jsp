		...
		<table
			...
			<tbody>
				...
				<tr>
					...
					<tr>
					<td class="width-20 active"><label class="pull-right">较大风险点名称：</label></td>
					<td class="width-30" >
					...
					<td class="width-30"><input  style="width: 100%;height: 30px;"class="easyui-textbox" name="M18" value="${sgfx.m18}"  data-options="required:'true'" /></td>
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">风险分类：</label></td>
					<td class="width30"><input class="easyui-combobox" style="width: 100%;height: 30px;" id="M2" name="M2" value="${sgfx.m2 }"  data-options="required:'true',
		         ...
		         <tr>
		            ...
		            <td class="width-30" ><input name="aprobability" id="aprobability" style="width: 100%;height: 30px;" class="easyui-combobox"
		                  value="${sgfx.aprobability }"/></td>
		            <td class="width-20 active"><label class="pull-right" style="color: red;">暴露频率(E)：</label></td>
		            <td class="width-30" ><input name="exposefrequency" id="exposefrequency" style="width: 100%;height: 30px;" class="easyui-combobox"
		                  value="${sgfx.exposefrequency }"/></td>
		         </tr>
		         
		         <tr>
		            <td class="width-20 active"><label class="pull-right" style="color: red;">严重度(C)：</label></td>
		            <td class="width-30" ><input name="aseverity" id="aseverity" style="width: 100%;height: 30px;" class="easyui-combobox"
		                  value="${sgfx.aseverity }" /></td>
					<td class="width-20 active"><label class="pull-right" style="color: red;">风险分级：</label></td>
					<td class="width-30" id="fenxi"><input class="easyui-combobox" readonly="readonly" style="width: 100%;height: 30px;" name="M9" id="M9" value="${sgfx.m9 }"  data-options="required:'true',
				 ...
				 <tr>
					...
					<td class="width-80"  colspan="3">
						<input  name="areaname" style="width: 100%;height: 30px;" class="easyui-textbox" value="${sgfx.areaname }"  data-options="validType:['length[0,50]'] " />
					</td>
				</tr>
            <tr>
					...
					<td class="width-80" colspan="3"><input  style="width: 100%;height: 30px;" id="sgfx_fxxx_m3" name="M3" class="easyui-combobox" value="${sgfx.m3 }"  data-options="
								required:'true',panelHeight:'auto',editable:true,data: [
								        {value:'纺织',text:'纺织'},
								        {value:'机械',text:'机械'},
								        {value:'建材',text:'建材'},
								        {value:'轻工',text:'轻工'},
				...
				<td class="width-20 active"><label class="pull-right">行业类别：</label></td>
					<td class="width-80" colspan="3"><input style="width: 100%;height: 30px;" class="easyui-combobox" id="sgfx_fxxx_m4" name="M4" value="${sgfx.m4 }"  data-options="required:'true',
								panelHeight:'150',editable:true , valueField: 'text',textField: 'text' "/></td>
				</tr>
					<tr>
...
<%--             <tr>
            ...
            <tr>
				...
				<tr>
					...
					<td class="width-80" colspan="3"><div><input name="M15" style="width: 100%;height: 30px;" value="${sgfx.m15 }"  class="easyui-textbox" data-options="validType:['length[0,500]'] " ></input></div></td>				
				</tr>
				  <tr>
