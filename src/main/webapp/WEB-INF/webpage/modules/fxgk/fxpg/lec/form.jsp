...
<body>
      ...
      <table id="rwtable" class="table table-bordered">
         ...
         <tbody>
            <tr>
               ...
               <td class="width-35"><input name="jobid" id="jobid" style="width: 100%;height: 30px;" class="easyui-combobox"
                     value="${entity.jobid }"
                     data-options="required:'true',editable: false,panelHeight:'100',valueField: 'id',textField: 'text',url:'${ctx}/bis/gzxx/textjson'" /></td>

            </tr>
            <tr>
               <td class="width-15 active"><label class="pull-right">工段：</label></td>
               <td class="width-35" colspan="3"><input name="m1" id="m1" style="width: 100%;height: 30px;" class="easyui-textbox"
                     value="${entity.m1 }" data-options=" " /></td>
            </tr>
            <tr>
               <td class="width-15 active"><label class="pull-right">工作任务：</label></td>
               <td class="width-35" colspan="3"><input name="work" id="work" style="width: 100%;height: 30px;" class="easyui-textbox"
                     value="${entity.work }" data-options="validType:'length[0,100]'" /></td>
            </tr>
            <tr>
   ...
   <script type="text/javascript">
				...
				function addaction() {
					openDialog("添加风险活动信息", ctx + "/fxpg/lec/actioncreate/", "800px", "400px", "");
				}
				function updaction(row) {
					time = row.time;
					openDialog("修改风险活动信息", ctx + "/fxpg/lec/actionupdate?time=" + row.time + "&data=" + encodeURIComponent(JSON.stringify(row)), "800px", "400px", "");
				}
