                ...
                <c:if test="${handler ne '0'}">
                    <tr>
                        ...
                        <td class="width-85"><input name="workflow_assigner" id="handler" type="text"
                                                    ...
                                                    style="width: 100%;height: 30px;"
                                                    data-options="
                                                    required:true,valueField:'text',textField:'text',url:'${ctx}/system/user/userjson' ">
                        </td>
                    </tr>
                </c:if>
            </c:if>
...
<script>
    ...
    var html = "";
    $.each(btns, function (index, value) {
        html += '<a class="layui-layer-btn' + index + '">' + value + '</a>';
    });
    html += '<a class="layui-layer-btn' + btns.length + '" onclick="closeLayer()">关闭</a>';
    parent.$('.layui-layer-btn').html(html);
