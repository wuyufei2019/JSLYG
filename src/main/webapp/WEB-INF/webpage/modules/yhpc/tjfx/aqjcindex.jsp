...
<div class="easyui-tabs" fit="true">
    ...
    <div title="人员统计" style="height:100%;" data-options="" id="user_tj">
     ...
     <div title="安全隐患类别占比" style="height:100%;" data-options="" id="">    
         <div class="col-lg-12">
            <div class="box2" style="margin-bottom: 5px" id="yhpc_tj">
               <div class="title">
                  <h5>安全隐患类别占比统计(默认当月)</h5>
               </div>
            <div class="col-lg-5" style="width: 45%;height: 30px;margin-top: 8px;margin-left: 29%;margin-bottom: 6px;">
            	<!-- 集团 -->
	            <c:if test="${qytype != '' and qytype == 'bloc'}">
	            	<input type="text" id="combo4" name="combo4" class="easyui-combobox" style="height: 30px;" data-options="prompt: '企业列表', idField: 'qyid', valueField: 'qyid', textField: 'qyname',
	             												url: ctx+'/yhpc/tjfx/qynamejson',
	             												onSelect: function(rec){
	             													qyid = rec.qyid;
	             													countByYhkind();
               ...
               <input type="text" id="yhkind_starttime" name="yhkind_starttime" class="easyui-datebox" style="height: 30px;" data-options="prompt: '开始时间'" />
               <input type="text" id="yhkind_endtime" name="yhkind_endtime" class="easyui-datebox" style="height: 30px;" data-options="prompt: '结束时间'" />
            ...
            <div class="ibox-content" style="margin: 0 20px">
                  <div class="echart" id="main4" style="width:100%;height:400px;margin-bottom: 60px;"></div>
               </div>
            </div>
         </div>
     </div>
