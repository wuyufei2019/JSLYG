...
<body>
	<div class="easyui-panel" title="网格员考核规则" style="width:100%;height:100%;" data-options=" headerCls:'myPanelHead'">
		<div class="easyui-layout" style="height:100%; ">
			...
			<div data-options="region:'center',split:true,border:false,title:'考核规则'">
				<div id="tg_tb" style="padding:5px;height:auto">
					<div>
						<shiro:hasPermission name="yhpc:wgkpicont:add">
							<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="add()" title="添加">
								<i class="fa fa-plus"></i> 添加
							</button>
						</shiro:hasPermission>
						<%--   <shiro:hasPermission name="yhpc:wgkpicont:update">
  				<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="upd()" title="修改"><i class="fa fa-file-text-o"></i>修改</button>
		        </shiro:hasPermission> --%>
						<shiro:hasPermission name="yhpc:wgkpicont:delete">
...
$(function(){   
    ...
    onClickRow:function(rowData){
     	wgcode=rowData.id;
     	wgid=rowData.s;
    	dg.datagrid('reload',{wgcode});
    }
	});
	
	dg=$('#dg').datagrid({   
	method: "get",
	url:'${ctx}/yhpc/wgkpi/content/list',
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
    ...
    onLoadSuccess: function(){
        $(this).datagrid("autoMergeCells",['name','score','content']);
    },  
    checkOnSelect:false,
   	selectOnCheck:false,
	});
...
function add() {
	...
	openDialog("添加网格员考核规则","${ctx}/yhpc/wgkpi/content/create","800px", "400px","");
}
...
function del(){
	...
	top.layer.confirm('删除后无法恢复您确定要删除？', {icon: 3, title:'提示'}, function(index){
		$.ajax({
			type:'get',
			url:ctx+"/yhpc/wgkpi/content/delete/"+ids,
