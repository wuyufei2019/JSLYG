...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/yhpc/bcrw/index.js?v=4"></script>
</head>
<body>

<form id="inputForm" action="${ctx}/yhpc/bcrw/${action}" method="post" class="form-horizontal">
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        <tbody>
        <tr>
            <td class="width-15 active"><label class="pull-right">班次名称：</label></td>
            <td class="width-35"><input data-options="required:'true',validType:'length[0,100]'" type="text" id="name"
                                        name="name" class="easyui-textbox" value="${bcrw.name}"
            ...
            <td class="width-35"><input
                    data-options="required:'true',panelHeight:'auto',editable:false,data: [
								        ...
								        {value:'3',text:'月检'},
								        {value:'4',text:'年检'}
								        ]" type="text" id="type" name="type" class="easyui-combobox"
                    value="${bcrw.type}"
                    style="height: 30px;width: 100%"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="4">
                <a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="addRw()"
                   title="添加任务"><i class="fa fa-plus"></i> 添加任务</a>
            </td>
        </tr>
        <tr>
            ...
            <td class="width-35" colspan="3">
                ...
                <div id="jcdIDs">
                    ...
                    <a href="javascript:void(0)" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left"
                       onclick="openjcdlist()" title="选择检查点"><i class="fa fa-plus"></i> 选择检查点</a>
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="width-35" colspan="3">
                ...
                <div id="xjryIDs">
                    ...
                    <div id="xjryList"></div>
                    <a href="javascript:void(0)" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left"
                       onclick="openxjrylist()" title="选择巡检人员"><i class="fa fa-plus"></i> 选择巡检人员</a>
                </div>
            </td>
        </tr>
        ...
        <c:if test="${not empty bcrw.ID}">
            ...
            <input type="hidden" name="createtime"
                   value="<fmt:formatDate value="${bcrw.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
...
<script type="text/javascript">
    ...
    if ('${action}' == 'update') {
        ...
        if (ids2 != null && ids2 != '' && ids2 != 'null') {
            ...
            for (var i = 0; i < arry1.length - 1; i++) {
                ...
                var $li2 = $("<div id=\"jcd_" + arry2[0] + "\" style=\"margin-bottom: 10px;\">"
                    + "<a style=\"color:#337ab7;text-decoration:none;cursor:pointer;margin-right:20px;\">"
                    + arry2[1]
                    + "</a>"
        ...
        if (bctype == 1) {
            ...
            $.each(sjlist, function (idx, obj) {
                ...
                $('#yuestart_' + rwid).combobox({
                    editable: false,
                    required: true,
                    data: [{value: '1', text: '1日'}, {value: '2', text: '2日'}, {value: '3', text: '3日'}, {
                        value: '4',
                        text: '4日'
                    }, {value: '5', text: '5日'},
                        {value: '6', text: '6日'}, {value: '7', text: '7日'}, {value: '8', text: '8日'}, {
                            value: '9',
                            text: '9日'
                        }, {value: '10', text: '10日'},
                        {value: '11', text: '11日'}, {value: '12', text: '12日'}, {
                            value: '13',
                            text: '13日'
                        }, {value: '14', text: '14日'}, {value: '15', text: '15日'},
                        {value: '16', text: '16日'}, {value: '17', text: '17日'}, {
                            value: '18',
                            text: '18日'
                        }, {value: '19', text: '19日'}, {value: '20', text: '20日'},
                        {value: '21', text: '21日'}, {value: '22', text: '22日'}, {
                            value: '23',
                            text: '23日'
                        }, {value: '24', text: '24日'}, {value: '25', text: '25日'},
                        {value: '26', text: '26日'}, {value: '27', text: '27日'}, {
                            value: '28',
                            text: '28日'
                        }, {value: '29', text: '29日'}, {value: '30', text: '30日'},
                        {value: '31', text: '31日'}],
                    onSelect: function () {
                        var startid = this.id;
    ...
    $.extend($.fn.validatebox.defaults.rules, {
        equalstime: {
            validator: function (value, param) {
                ...
                if (!isNaN(starth) && !isNaN(endh) && value!="00:00:00")
        ...
        equalsendtime: {
            validator: function (value, param) {
                ...
                var starth = $('#' + startid).timespinner('getHours');
                var endh = parseInt(value.split(":")[0]);
                var startm = $('#' + startid).timespinner('getHours');
                var endm = parseInt(value.split(":")[1]);
                if (!isNaN(starth) && !isNaN(endh)&& value!="00:00:00")
                    return starth * 60 + startm < endh * 60 + endm;
                else
                    return true;
    ...
    function addRw() {
        ...
        if (type == 1) {
            var size = $("#rwtable tr").size();
            if (size == 1) {
                addDayWork("00:00", "01:00");
            } else {
                var shour = $('#ristart_' + (rwid - 1)).timespinner("getHours");
                var ehour = $('#riend_' + (rwid - 1)).timespinner("getHours");
                var smin = $('#ristart_' + (rwid - 1)).timespinner("getMinutes");
                var emin = $('#riend_' + (rwid - 1)).timespinner("getMinutes");
                var sub = ehour - shour;
                addDayWork((shour+sub)+":"+smin,(ehour+sub)+":"+emin);
            ...
            $('#yuestart_' + rwid).combobox({
                ...
                data: [{value: '1', text: '1日'}, {value: '2', text: '2日'}, {value: '3', text: '3日'}, {
                    ...
                    {value: '11', text: '11日'}, {value: '12', text: '12日'}, {value: '13', text: '13日'}, {
                        value: '14',
                        text: '14日'
                    }, {value: '15', text: '15日'},
                    {value: '16', text: '16日'}, {value: '17', text: '17日'}, {value: '18', text: '18日'}, {
                        value: '19',
                        text: '19日'
                    }, {value: '20', text: '20日'},
                    {value: '21', text: '21日'}, {value: '22', text: '22日'}, {value: '23', text: '23日'}, {
                        value: '24',
                        text: '24日'
                    }, {value: '25', text: '25日'},
                    {value: '26', text: '26日'}, {value: '27', text: '27日'}, {value: '28', text: '28日'}, {
                        value: '29',
                        text: '29日'
                    }, {value: '30', text: '30日'},
                    {value: '31', text: '31日'}],
    ...
    function addDayWork(d1, d2) {
        var $list = $("#rwtable tr").eq(-1);
        var $li = $(
            '<tr style="height:40px" >' +
            '<td style="width:37%" align="center">' +
            '<input data-options="" type="text" id="ristart_' + rwid +
            '" name="start" class="easyui-textbox"   style="height: 30px;width: 230px" />' +
            '</td>' +
            '<td style="width:37%" align="center">' +
            '<input data-options="" type="text" id="riend_' + rwid + '" name="end" class="easyui-textbox" ' +
        ...
        $('#ristart_' + rwid).timespinner('setValue', d1);
        $('#riend_' + rwid).timespinner('setValue', d2);
        rwid++;
    }
