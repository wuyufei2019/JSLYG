            ...
            <tr>
               ...
               <c:choose>
				    <c:when test="${deptid != null && deptid != '' }">
						...
						class="easyui-combobox" style="width: 100%;height: 30px;" readonly='true'
				...
				$("#t_id1").combobox({
									onSelect : function(rec) {
										...
										var html2 = "<tr id='q'>"
												...
												+ "<td class='width-15 active'><label class='pull-right textred'>预算（万元）：</label></td>"
												+ "<td class='width-20 active'><label class='pull-right textred'>责任人：</label></td>"
												+ "<td class='width-30 active'><label class='pull-right textred'>预计完成时间：</label></td>"
												+ "</tr>";
										if (arr == 1) {
											$("#tr2").after(html2);
										}
										...
										var html = "<tr id="+rec.id+" name='all'>"
												...
												+ "<td class='width-15'><input name='M11' class='easyui-textbox' value='${target.m11 }' style='width: 120px;height: 30px;'data-options=\"validType:'mone'\" /></td>"
												+ "<td class='width-20'><input id='M12' name='M12' type='text' value='${target.m12 }' class='easyui-combobox' style='width: 100%;height: 30px;' data-options=\"panelHeight:'120',editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/system/compuser/userjson?bmid="+bmid+"'\"></td>"
												+ "<td class='width-20'><input name='M13' value='${target.m13 }' class='easyui-datebox' style='width: 100%;height: 30px;'/></td>"
												+ "</tr>";
										/* "<tr id="+rec.id+">"+
