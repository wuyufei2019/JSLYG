     ...
     <form id="inputForm" action="${ctx}/aqsctr/fysy/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					<td class="width-20 active"><label class="pull-right">金额：</label></td>
					<td class="width-30"><input required="true" style="width: 100%;height: 30px;" id="M4" name="M4" class="easyui-numberbox" value="${fysy.m4 }" data-options="validType:['number','length[0,10]'] " /></td>
				...
				<tr>
					...
					<td class="width-30" colspan="3"><input id="M8" name="M8" class="easyui-textbox" style="width: 100%;height: 80px;" value="${fysy.m8 }" data-options="multiline:true, editable:true " /></td>
				</tr>
