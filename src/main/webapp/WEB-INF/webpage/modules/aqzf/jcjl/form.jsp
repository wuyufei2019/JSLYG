...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/jcjl/index.js?v=1.5"></script>
</head>
<body>
			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<input type="hidden" name="jcnrm6" value="${jcjl.m15}" />
				</tbody>
			</table>
       </form>
	...
	var target=$('#tt').datagrid({
        ...
        detailFormatter:function(rowIndex, rowData){
			...
			return '<div id="ddv-' + rowIndex + '" ><table style="width: 98%;">' +
					...
					'<tr>'+
					'<td>' +
					'<input type="text" id="zgwt_' + rowData.id + '" name="zgwt_' + rowData.id + '" style="width: 667px;height: 30px;" />' +	
					'</td>'+									
					'</tr>'+
					'<tr>'+
					'<td>' +
