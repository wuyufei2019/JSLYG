			  ...
			  <tbody>
				...
				<tr>
				    <td align="center" colspan="4">
						<a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="addJcnr(${version})" title="添加检查内容"><i class="fa fa-plus"></i> 添加检查内容</a>
					</td>	
				</tr>
				...
				<tr>
				    <td align="center" colspan="4">
						<a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" onclick="addNr(${version})" title="其他问题"><i class="fa fa-plus"></i> 其他问题</a>
					</td>	
				</tr>
