...
<head>
    ...
    <script type="text/javascript" src="${ctx}/static/model/js/aqzf/jcjl/index.js?v=2.0"></script>
</head>
<body>
<!-- 工具栏 -->
<div id="aqzf_jcjl_tb" style="padding:5px;height:auto">
    <form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">
        <div class="form-group">
            <input type="text" name="aqzf_jcjl_qyname" class="easyui-combobox" style="height: 30px;"
                   data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
            <input name="aqzf_jcjl_M6" class="easyui-datetimebox" style="height: 30px;"
                   data-options="editable:false,prompt: '检查起始时间'"/>
            <input name="aqzf_jcjl_M7" class="easyui-datetimebox" style="height: 30px;"
                   data-options="editable:false,prompt: '检查结束时间'"/>
        ...
        <div class="col-sm-12">
            <div class="pull-left">
                <shiro:hasPermission name="aqzf:jcjl:add">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="addJcjl()"
                ...
                <shiro:hasPermission name="aqzf:jcjl:exportword">
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left"
                            onclick="fileexport()" title="导出现场检查记录"><i class="fa fa-file-word-o"></i> 导出现场检查记录
                    </button>
                </shiro:hasPermission>
