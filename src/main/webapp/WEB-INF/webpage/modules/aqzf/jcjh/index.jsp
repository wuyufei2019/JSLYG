...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/jcjh/index.js?v=1.2"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="aqzf_jcjh_tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">				
		<div class="form-group">
			...
			<input type="text" name="aqzf_jcjh_qyname" class="easyui-combobox" style="height: 30px;" data-options="editable:true ,valueField: 'text',textField: 'text',url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
<%--			<input type="text" name="aqzf_jcjh_qyfz" class="easyui-combotree" style="height: 30px;" data-options="editable:false,valueField: 'id',textField: 'text',url:'${ctx}/system/admin/xzqy/xzqyjson',prompt: '企业分组' "/>	--%>
		...
		<div class="col-sm-12">
			<div class="pull-left">
				<shiro:hasPermission name="aqzf:jcjh:add">
					<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="addjh()" title="添加"><i class="fa fa-plus"></i> 添加</button>
			       	<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="add()" title="双随机"><i class="fa fa-plus"></i> 双随机</button>
				</shiro:hasPermission>
