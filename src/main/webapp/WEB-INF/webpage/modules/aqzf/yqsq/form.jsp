...
<form id="inputForm" action="${ctx}/aqzf/yqsq/${action}"
    ...
    <table
        ...
        <tr>
            ...
            <td class="width-30"><input type="text" class="easyui-textbox"
                                        value="${entity.number }" name="number"
                                        data-options="readonly:'true' " style="height: 30px;width: 100%"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="width-30" colspan="3">
                <input type="text" id="M2" name="M2" class="easyui-textbox" value="${entity.m2 }"
                       data-options="multiline:true,validType:'length[0,500]'" style="height: 80px;width: 100%;"/>
            </td>
        </tr>
