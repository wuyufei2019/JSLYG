...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/sjwh/zfry/index.js?v=3"></script>
</head>
<body >
<div id="aqzf_zfry_tb" style="padding:5px;height:auto">
	...
	<%--<input type="text" id="aqzf_zfry_M8" name="aqzf_zfry_M8" style="height: 30px;"
	...
	<div class="col-sm-12">
		...
		<span id="divper">
        	...
        	<shiro:hasPermission name="aqzf:zfry:manage">
        		<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="manage()" title="人员分组管理"><i class="fa fa-bars"></i> 人员分组管理</button> 
        	</shiro:hasPermission>
