			...
			<form id="inputForm" class="form-horizontal">
				...
				<table
					...
					<tbody>
						...
						<tr>
							<td class="width-22 active"><label class="pull-right">承办机构：</label></td>
							<td class="width-28"><input name="cbjg" style="width:250px;height:30px;" class="easyui-textbox"
								value="${bh.cbjg }"
						...
						<tr>
							...
							<td class="width-22 active"><label class="pull-right">上级应急部门：</label></td>
                                   <td class="width-28"><input name="highgov" style="width:250px;height:30px;" class="easyui-textbox"
                                        value="${bh.highgov }"
