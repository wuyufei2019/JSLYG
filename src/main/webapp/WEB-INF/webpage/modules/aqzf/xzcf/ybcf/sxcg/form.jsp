			...
			<tbody>
				...
				<tr>
					...
					<input name="qyname" id="qyname" class="easyui-textbox" value="${yse.qyname }"editable="false"style="width: 100%;height: 30px;" 
                         data-options="validType:['length[0,100]'],required:'true'"/>
					</td>
					<td class="width-20 active"><label class="pull-right">事先催告日期：</label></td>
                    <td class="width-30"><input id="sxcgsj"name="sxcgsj" class="easyui-datebox" value="${yse.sxcgsj }" 
                         style="width: 100%;height: 30px;"data-options="editable:false"/></td>
				</tr>
		        <tr>
					<td class="width-20 active"><label class="pull-right">尚未履行的行政处罚：</label></td>
                 ...
                 <tr>
                <td class="width-20 active"><label class="pull-right">罚款缴纳截止日期：</label></td>
...
$(function(){
	...
	$('#sxcgsj').datebox('setValue', format(new Date()));	
