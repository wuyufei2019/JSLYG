          ...
          class="form-horizontal">
               ...
               <table
                 ...
                 <tbody>
                    <c:if test="${action eq 'updateSub'}">
                         <tr>
                              ...
                              <td class="width-35" colspan="3"><input name="number"
                    ...
                    <tr>
                         ...
                         <td class="width-35"><input id="punishdate" name="punishdate"
                    ...
                    <tr name="company">
                         ...
                         <td class="width-35"><input id="duty" name="duty"
                    ...
                    <tr name="company">
                         ...
                         <td class="width-35"><input id="mobile" name="mobile"
                         ...
                         <td class="width-35"><input name="ybcode" type="text" id="ybcode"
                    ...
                    <tr name="company">
                         ...
                         <td class="width-35" colspan="3"><input id="address" name="address"
                    ...
                    <tr name="person">
                         ...
                         <td class="width-35"><input id="persex" name="sex"
                         ...
                         <td class="width-35"><input id="perage" name="age"
                    ...
                    <tr name="person">
                         <td class="width-15 active"><label class="pull-right">电话：</label></td>
                         <td class="width-35"><input id="pmobile" name="mobile"
                                   class="easyui-textbox" value="${jce.mobile }"
                                   style="width: 100%;height: 30px;" validtype="mobileAndTel" /></td>
                         <td class="width-15 active"><label class="pull-right">身份证号：</label></td>
                         <td class="width-35"><input id="identity" name="identity1"
                    ...
                    <tr name="person">
                         ...
                         <td class="width-35" colspan="3"><input id="paddress" name="address"
                                   class="easyui-textbox" value="${jce.address }"
                                   style="width: 100%;height: 30px;"
                                   data-options="validType:['length[0,100]']" /></td>
                    </tr>
                    ...
                    <tr name="person">
                         ...
                         <td class="width-35"><input id="dwname" name="dwname"
                                   class="easyui-textbox" value="${jce.dwname }"
                                   style="width: 100%;height: 30px;" /></td>
                         <td class="width-15 active"><label class="pull-right">职务：</label></td>
                         <td class="width-35"><input id="perduty" name="duty"
                                   class="easyui-textbox" value="${jce.duty }"
                                   style="width: 100%;height: 30px;" /></td>
                    </tr>
                    ...
                    <tr name="person">
                         ...
                         <td class="width-35" colspan="3"><input id="dwaddress"
                    ...
                    <tr>
                         ...
                         <td class="width-35" colspan="3"><input id="illegalactandevidence"
				...
				<td class="width-15 active"><label class="pull-right">违法行为：</label></td>
					...
					<input id="wfxw" name="wfxw"  class="easyui-textbox" value="${jce.wfxw }" style="width: 100%;height: 80px;" data-options="multiline:true,validType:['length[0,500]']"/></td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">主要证据：</label></td>
					<td class="width-35" colspan="3">
					<input id="evidence" name="evidence"  class="easyui-textbox" value="${jce.evidence }" style="width: 100%;height: 100px;" data-options="multiline:true , validType:['length[0,1000]']"/></td>
				</tr> 
                    <tr>
                         <td class="width-15 active"><label class="pull-right">违反条款：</label></td>
                         <td class="width-35" colspan="3"><input id="unlaw" name="unlaw"
                    ...
                    <tr>
                         ...
                         <td class="width-35" colspan="3"><input id="enlaw" name="enlaw"
                    ...
                    <tr>
						...
						<td class="width-35" colspan="3"><input id="xzcf" name="xzcf"  class="easyui-textbox" value="${jce.xzcf }" style="width: 100%;height: 50px;" data-options="multiline:true,validType:['length[0,250]']"/></td>
					</tr>
                    <tr>
                         <td class="width-15 active"><label class="pull-right">详情：</label></td>
                         <td class="width-35" colspan="3"><input id="punishresult"
                                   name="punishresult" class="easyui-textbox"
                                   value="${jce.punishresult }" style="width: 100%;height: 200px;"
     ...
     <script type="text/javascript">
						$(function() {
							if ('${action}' == 'createSub') {
								...
								$("#illegalactandevidence").textbox("setValue", '${gie.illegalact}');
								$("#wfxw").textbox("setValue", '${gie.wfxw}');
								$("#evidence").textbox("setValue", '${gie.evidence}');
								$("#xzcf").textbox("setValue", '${gie.xzcf}');
								$("#unlaw").textbox("setValue", '${gie.unlaw}');
								$("#enlaw").textbox("setValue", '${gie.enlaw}');
								$("#punishresult").textbox("setValue", '${xq}');
								$("input[name='id1']").val('${id1}');
								if('${ajcp.percomflag}'==1){
								comResult();
								$("#qyname").textbox("setValue", '${ajcp.punishname}');
								$("#mobile").textbox("setValue", '${lasp.contact}');
