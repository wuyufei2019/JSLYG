			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<td class="width-30" colspan="3"><input name="M16" type="text" value="${cssbbl.m16 }"   class="easyui-textbox" style="width: 100%;height: 200px;" data-options="multiline:true, validType:'length[0,2500]' "></td>					
				</tr>
