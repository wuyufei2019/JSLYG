			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<td class="width-30" colspan="3"><input name="M10" type="text" value="${jttl.m10 }"   class="easyui-textbox" style="width: 100%;height: 150px;" data-options="multiline:true"></td>					
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">讨论记录：</label></td>
					<td class="width-30" colspan="3"><input name="M11" type="text" value="${jttl.m11 }"   class="easyui-textbox" style="width: 100%;height: 150px;" data-options="multiline:true"></td>					
				</tr>
				<tr>
					<td class="width-20 active"><label class="pull-right">结论性意见：</label></td>
					<td class="width-30" colspan="3"><input name="M12" type="text" value="${jttl.m12 }"   class="easyui-textbox" style="width: 100%;height: 100px;" data-options="multiline:true"></td>					
				</tr>
