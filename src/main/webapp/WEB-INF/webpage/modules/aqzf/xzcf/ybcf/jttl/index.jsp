...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/jttl/index.js?v=1.2"></script>
</head>
<body >
	...
	<div class="col-sm-12">
		...
		<span id="divper">
        	...
        	<shiro:hasPermission name="aqzf:jttl:export">
        		<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="fileexport()" title="导出集体讨论表"><i class="fa fa-file-word-o"></i> 导出集体讨论表</button> 
        	</shiro:hasPermission>
        	</span>
        	<span id="divper2">
			</span>
