...
<body>
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
                ...
                <tr>
                    ...
                    <td class="width-30" >
                        <c:if test="${yle.cfdxlx == '2'}">
                            <input class="easyui-validatebox" disabled type="radio" style="margin-bottom: 6px;"  />公司
                            <input class="easyui-validatebox" disabled type="radio" style="margin-bottom: 6px;margin-left: 20px;" checked/>个人
                        </c:if>
                        <c:if test="${yle.cfdxlx == '1' || yle.cfdxlx == '' || yle.cfdxlx == null}">
                            <input class="easyui-validatebox" disabled type="radio" style="margin-bottom: 6px;" checked/>公司
                            <input class="easyui-validatebox" disabled type="radio" style="margin-bottom: 6px;margin-left: 20px;"  />个人
                        </c:if>
                    </td>
                </tr>
				<tr>
