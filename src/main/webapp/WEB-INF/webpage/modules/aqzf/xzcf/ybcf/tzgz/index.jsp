...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/tzgz/index.js?v=1.6"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="ybcf_tzgz_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		...
		<input type="text" name="ybcf_tzgz_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '当事人'" />
		听证告知时间:
