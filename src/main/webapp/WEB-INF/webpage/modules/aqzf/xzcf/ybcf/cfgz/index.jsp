...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/cfgz/index.js?v=1.7"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="ybcf_cfgz_tb" style="padding:5px;height:auto">
	...
	<div class="form-group">
		...
		<input type="text" name="ybcf_cfgz_name" class="easyui-textbox" style="height: 30px;" data-options="prompt: '当事人'" />
          处罚告知时间:
