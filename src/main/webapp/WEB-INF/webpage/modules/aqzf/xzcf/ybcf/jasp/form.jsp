     ...
     <form id="inputForm" action="${ctx}/xzcf/ybcf/jasp/${action}"  method="post" class="form-horizontal" >
		...
		<c:if test="${action eq 'updateSub'}">
				...
				<tr name="person" >
					...
					<td class="width-30" ><input id="pmobile" name="mobile" class="easyui-textbox"  value="${yje.mobile }" style="width: 100%;height: 30px;" validtype="mobileAndTel"/></td>
				...
				<tr >
					...
					<td class="width-30" colspan="3" ><input id="result"name="result" value="${yje.result }"   class="easyui-textbox" style="width: 100%;height: 150px;"data-options="multiline:true,multiple:true,validType:['length[0,1000]']"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-30"><input type="text" id="fzshr" name="fzshr" class="easyui-combobox" value="${yje.fzshr }" style="width: 100%;height: 30px;" data-options="panelHeight:'150px', editable:true ,valueField: 'text', textField: 'text',url:'${ctx}/aqzf/zfry/idlist' "/></td>
					<td class="width-20 active"><label class="pull-right">法制审核日期：</label></td>
					<td class="width-30"><input id="fzshsj" name="fzshsj" class="easyui-datebox" value="${yje.fzshsj }" style="width: 100%;height: 30px;" data-options="editable:false" /></td>
				</tr>    
