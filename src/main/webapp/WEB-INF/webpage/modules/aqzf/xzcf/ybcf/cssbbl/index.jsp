...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqzf/xzcf/ybcf/cssbbl/index.js?v=1.3"></script>
</head>
<body >
<div id="aqzf_cssbbl_tb" style="padding:5px;height:auto">
	<form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">				
	<div class="form-group">
		<input type="text" name="aqzf_cssbbl_labh" class="easyui-textbox" style="height: 30px;" data-options="prompt: '立案编号'" />
