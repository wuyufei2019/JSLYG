			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<td class="width-35"><input class="easyui-textbox" id="M3" name="M3" value="${jcfa.m3 }"
...
$(function(){
	...
	if('${action}' == 'create'){
		var leibie = '${leibie}';
		if(leibie == '1'){
			$('#M3').textbox("setValue", "工矿");
		}else if(leibie == '2'){
			$('#M3').textbox("setValue", "危险化学品");
		}else if(leibie == '3'){
            $('#M3').textbox("setValue", "烟花爆竹");
		}else{
            $('#M3').textbox("setValue", "其他");
		}
	}
