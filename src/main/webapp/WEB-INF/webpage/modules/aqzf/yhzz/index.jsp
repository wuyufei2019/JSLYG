...
<head>
	...
	<script type="text/javascript" src=" ${ctx}/static/model/js/aqzf/yhzz/index.js?v=1.2"></script>
</head>
<body >
<!-- 工具栏 -->
      ...
      <form id="searchFrom" style="margin-bottom: 8px;" class="form-inline">
         <div class="form-group">
            <c:if test="${usertype ne '1'}">
       	        <input type="text" name="filter_qyid" class="easyui-combobox" style="height: 30px;"
                       data-options="valueField: 'id',textField: 'text',
                 url:'${ctx}/bis/qyjbxx/idjson',prompt: '企业名称' "/>
            </c:if>
            <input type="text" name="filter_number" class="easyui-textbox" style="height: 30px;"
                   data-options="prompt: '检查记录编号'" />
