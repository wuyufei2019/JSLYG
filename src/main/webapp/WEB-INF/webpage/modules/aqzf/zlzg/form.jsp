...
if ('${action}' == 'create') {
	$.each(wfxw, function(idx, obj) {
	    var $tdHtml = $('<input type="checkbox" onclick="addnr()" name="wfxwid" style="margin-bottom:6px;" value="'+obj.ID+'"/>检查情况：'+obj.wtms+'<br/>&nbsp;&nbsp;&nbsp;&nbsp;须整改的问题：'+obj.zgwt+'<br/>&nbsp;&nbsp;&nbsp;&nbsp;涉嫌违法行为：'+obj.m1+'<br/>');	
		$list.append( $tdHtml );
	});
}
...
if ('${action}' == 'update'){
	...
	$.each(wfxw, function(idx, obj) {
		if(allwfxw.indexOf(','+obj.ID+',')!=-1){
			var $tdHtml = $('<input type="checkbox" checked="checked" onclick="addnr()" name="wfxwid" style="margin-bottom:6px;" value="'+obj.ID+'"/>检查情况：'+obj.wtms+'<br/>&nbsp;&nbsp;&nbsp;&nbsp;须整改的问题：'+obj.zgwt+'<br/>&nbsp;&nbsp;&nbsp;&nbsp;涉嫌违法行为：'+obj.m1+'<br/>');	
			$list.append( $tdHtml );
		}else{
			var $tdHtml = $('<input type="checkbox" onclick="addnr()" name="wfxwid" style="margin-bottom:6px;" value="'+obj.ID+'"/>'+obj.wtms+'<br/>&nbsp;&nbsp;&nbsp;&nbsp;涉嫌违法行为：'+obj.m1+'<br/>');	
			$list.append( $tdHtml );
		}
	});
}
