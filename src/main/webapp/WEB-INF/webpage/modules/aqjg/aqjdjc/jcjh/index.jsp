...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqjg/aqjdjc/jcjh/index.js?v=2.0"></script>
</head>
<body >
<!-- 工具栏 -->
<div id="aqjg_jcjh_tb" style="padding:5px;height:auto">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="aqjd:jcjh:add">
		       		<button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="add()" title="添加"><i class="fa fa-plus"></i> 添加</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="aqjd:jcjh:update">
			    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="upd()" title="修改"><i class="fa fa-file-text-o"></i> 修改</button> 
			</shiro:hasPermission>
			<shiro:hasPermission name="aqjd:jcjh:delete">
