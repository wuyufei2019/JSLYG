	...
	<div id="ssjc_wl_tb" style="padding:5px;height:auto">
		...
		<div class="col-sm-12">
			...
			<div class="pull-left">
				...
				<input type="text" id="ssjc_wl_qy_name" name="ssjc_wl_qy_name" class="easyui-combobox"  style="height: 30px;width:250px;" data-options="editable:true ,valueField: 'm1',textField: 'm1',url:'${ctx}/zxjkyj/cgssjc/qyjson',prompt: '企业名称',
	...
	<div class="easyui-tabs" fit="true">
			<div title="图形显示" style="height:100%;">
				<div style="height: 99.5%">
					<iframe src="${ctx}/zxjkyj/cgssjc/view/${qyid}" frameborder="0" width="100%" height="100%"></iframe>
				</div>
			</div>
...
$(function(){   
    ...
    columns:[[    
        ...
        {field:'gj',title:'罐径(m)',sortable:false,width:60,align:'center',
     	...
     	{field:'yw',title:'液位(mm)',sortable:false,width:80,align:'center',
        	formatter : function(value, row, index) {
        		if (value!=null)
        ...
        {field:'yl',title:'压力(MPa)',sortable:false,width:80,align:'center',
     	...
     	{field:'sj',title:'更新时间',sortable:false,width:100,align:'center',
         	formatter : function(value, row, index) {
    ...
    onDblClickRow: function (rowdata, rowindex, rowDomElement){
    	if(usertype!='1' )
    		showqycg(rowindex.qyid,rowindex.qyname);
    },
