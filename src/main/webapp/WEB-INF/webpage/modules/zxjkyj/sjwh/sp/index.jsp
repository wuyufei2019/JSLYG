...
$(function(){   
    ...
    columns:[[    
		...
		{field:'rtsp',title:'RTSP视频流',sortable:false,width:170,align:'center'},
		{field:'apiaddress',title:'接口请求地址',sortable:false,width:80,align:'center'},
        {field:'playaddress',title:'播放地址',sortable:false,width:80,align:'center' },
        {field:'url',title:'视频流url',sortable:false,width:150,align:'center' },
