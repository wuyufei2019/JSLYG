	     ...
	     <form id="inputForm" action="${ctx}/bis/spjk/${action}"  method="post" class="form-horizontal" >
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  ...
			  <c:if test="${usertype != '1' and action eq 'create'}">
				...
				<tr >  
					<td class="width-15 active"><label class="pull-right"> RTSP视频流 ：</label></td>
					<td><input name="rtsp" type="text" class="easyui-textbox" value="${video.rtsp }" style="width: 400px;height: 30px;"  data-options="required:'true',width:400"/></td>
				</tr>
				<tr >  
					<td class="width-15 active"><label class="pull-right">接口请求地址：</label></td>
					<td><input name="apiaddress" type="text" class="easyui-textbox" value="${video.apiaddress }" style="width: 400px;height: 30px;"  data-options="required:'true',width:400,validType:'xhtt_numberDecimalsCheck'"/></td>
				</tr>
				<tr>  
					<td class="width-15 active"><label class="pull-right">视频播放地址 ：</label></td>
					<td><input name="playaddress" type="text" class="easyui-textbox" value="${video.playaddress }" style="width: 400px;height: 30px;"   data-options="required:'true',width:400"/></td>
				</tr>
