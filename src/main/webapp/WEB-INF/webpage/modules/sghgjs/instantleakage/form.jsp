...
<form id="instantleakage_form" class="form-horizontal" >
	...
	<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
		...
		<tr >
			...
			<td><input id="instantleakage_form_id_m2" name="M2" class="easyui-textbox" style="width:100px;height: 30px;" data-options="required:'true',validType:'number'" />（kg/㎥）</td>
			<td class="width-15 active"><label class="pull-right">泄漏质量：</label></td>
			<td><input id="instantleakage_form_id_m3" name="M3" class="easyui-textbox" value="100000" style="width:100px;height: 30px;" data-options="required:'true',validType:'number'" />（kg）</td>
		</tr>
		<tr >
