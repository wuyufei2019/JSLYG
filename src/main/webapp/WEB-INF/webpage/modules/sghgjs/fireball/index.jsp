...
<div id="fireball_yjcl_win" style="display: none;">
    <table id="fireball_yjcl_dg" class="yjcl_table">
        ...
        <tr>
            <td class="yjcl_table_td">请选择企业:</td>
...
<script type="text/javascript">
    ...
    if (usertype != '' && usertype != null) {
        var lng2 = '${lng2}';//经度
        var lat2 = '${lat2}';//纬度
        initMap("fireballdituContent", lng2, lat2, 16);
    } else {
        var lng = '${lng}';//经度
        var lat = '${lat}';//纬度
        //初始化地图
        initMap("fireballdituContent", lng, lat, 16);
    }
    ...
    $('#bis_cjxx_qy_name').combobox({
        onChange : function(n,o){
            ...
            $.ajax({
                url: ctx + '/sghgjs/fireball/getjwd',
                type: "get",
                data: {"qyid": qyid},
                dataType: "json",
                success: function (data) {
