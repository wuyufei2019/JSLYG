	...
	<div class="col-sm-12">
		<div class="pull-left">
        	...
        	<shiro:hasPermission name="rcxxpxjl:pxjl:exin">
				<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/aqpx/rcxxpxjl/exinjump','${ctx}/aqpx/rcxxpxjl/exin','${ctx}/static/templates/线下培训信息导入模板.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission>
