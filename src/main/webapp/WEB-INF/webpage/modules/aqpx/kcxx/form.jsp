...
<head>
	...
	<script type="text/javascript" src="${ctx}/static/model/js/aqpx/kcxx/index.js?v=1.6"></script>
</head>
<body>
			  ...
			  <tbody>
				...
				<tr>
					...
					<td class="width-35" colspan="3">
					    ...
					    <a  href="javascript:void(0)"  class="btn btn-info btn-sm" data-toggle="tooltip"
							data-placement="left" onclick="openkjlist()" title="选择课件"><i class="fa fa-plus"></i>
							私有课件库中选择</a>
					    <a  href="javascript:void(0)"  class="btn btn-info btn-sm" data-toggle="tooltip"
							data-placement="left" onclick="openPubList()" title="选择课件"><i class="fa fa-plus"></i>
							公有课件库中选择</a>
					</div>
					</td>
				</tr>
