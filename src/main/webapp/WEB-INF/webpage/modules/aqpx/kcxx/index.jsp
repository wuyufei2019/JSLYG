...
<body>
<!-- 工具栏 -->
<div id="aqpx_kcxx_tb" style="padding:5px;height:auto">
    <form id="searchFrom" action="" style="margin-bottom: 8px;" class="form-inline">

        <div class="form-group">
            <input type="text" id="aqpx_kcxx_cx_m1" name="aqpx_kcxx_cx_m1" class="easyui-textbox" style="height: 30px;"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pull-left">
                ...
                <shiro:hasPermission name="aqpx:kcxx:export">
