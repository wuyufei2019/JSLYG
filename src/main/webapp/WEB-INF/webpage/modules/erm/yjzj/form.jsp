			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				...
				<tr>
					...
					<td class="width-15 active"><label class="pull-right">专家组别：</label></td>
					<td class="width-35"><input style="width: 100%;height: 30px;" name="M17" class="easyui-combobox" value="${res.m17 }" data-options="editable:false ,data: [
								        {value:'综合组',text:'综合组'},
								        {value:'工贸组',text:'工贸组'},
								        {value:'应急救援组',text:'应急救援组'},
								        {value:'化工组',text:'化工组'},
								        {value:'化工组、应急救援组',text:'化工组、应急救援组'},
								        {value:'矿山组',text:'矿山组'},
								        {value:'职业健康组',text:'职业健康组'},
								        {value:'工贸组、应急救援组',text:'工贸组、应急救援组'},
								        {value:'化工组、工贸组',text:'化工组、工贸组'}
								        {value:'其他',text:'其他'} ]
						    " /></td>
				</tr>	
				...
				<tr>
					...
					<td class="width-85" colspan="3">
						<input name="M23" type="text" value="${res.m23 }"   class="easyui-textbox" style="width: 100%;height: 80px;" data-options="multiline:true , validType:'length[0,250]'">
					</td>
