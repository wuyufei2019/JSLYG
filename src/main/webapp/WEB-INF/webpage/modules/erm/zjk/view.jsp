			...
			<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer" >
			  <tbody>
				<tr>
		            ...
		            <td class="width-35"><input id="r1" type="radio"  name="M2" value="1" /> 男<input id="r2" type="radio"  name="M2" value="0" />女<input id="hiddensex" type="hidden" value="${res.m2}" /></td>
				...
				<tr>
					...
					<td class="width-35"><label><input id="r3" name="mark" type="radio" value="0" checked  />否 </label>
						<label><input id="r4" name="mark" type="radio" value="1" />是 </label> <input id="hiddenmark" type="hidden" value="${res.mark}" /></td>
				</tr>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">图片附件：</label></td>
					<td class="width-85" colspan="3">
						<c:if test="${not empty res.fj}">
							<c:forTokens items="${res.fj}" delims="," var="url" varStatus="urls">
...
<script type="text/javascript">
	...
	val2 = $("#hiddenmark").attr("value");
	if(val2=="1"){
		$("input[name='mark'][value=1]").attr("checked",true);
	}
	if(val2=="0"){
		$("input[name='mark'][value=0]").attr("checked",true);
	}
	$(function(){ 
