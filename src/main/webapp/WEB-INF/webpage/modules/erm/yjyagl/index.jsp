...
<div id="erm_yjyagl_tb" style="padding:5px;height:auto">
	...
	<div class="col-sm-12">
		...
		<span id="divper">
			...
			<button class="btn btn-white btn-sm " data-toggle="tooltip" data-placement="left" onclick="openImportDialog('${ctx}/erm/yjyagl/exinjump','${ctx}/erm/yjyagl/exin','${ctx}/static/templates/应急预案管理导入模板.xls')" title="导入"><i class="fa fa-folder-open-o"></i> 导入</button>
			<%--</shiro:hasPermission>--%>
