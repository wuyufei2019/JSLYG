...
$(function(){
    ...
    columns:[[    
			...
			{field : 'createtime',title : '检查时间',sortable : true,width : 70,align : 'center',
				formatter : function(value, row, index) {
	              	if(value!=null&&value!='') {
			...
			{field : 'checkresult',title : '检查结果',sortable : true,width : 40,align : 'center',
				formatter : function(value, row, index) {
              		if(value=='0'){
              			return '无隐患';
              		}else if(value=='1'){
...
function fileexport(){
	...
	layer.open({
        ...
        maxmin: false, 
        shift: 1,
	    content: ctx+'/yhpc/xjjl/colindex2',
		btn: ['导出'],
