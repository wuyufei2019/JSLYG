...
$(function(){
    ...
    columns:[[    
		...
		{field:'qyname',title:'企业名称',sortable:true,width:80,align:'center'},
              {field:'m1',title:'计划名称',sortable:true,width:80},

              {field:'m2',title:'培训类别',sortable:true,width:50,align:'center'},
              {field:'m3',title:'培训学时',sortable:true,width:50,align:'center'},
              {field:'m5',title:'开始日期',sortable:true,width:50,align:'center',
              ...
              {field:'m6',title:'结束日期',sortable:true,width:50,align:'center',
              ...
              {field:'m4',title:'制定日期',sortable:true,width:50,align:'center',
          	  formatter : function(value, view ,index){
                	if(value!='') {
              		    var datetime=new Date(value);
              		    return datetime.format('yyyy-MM-dd');  
              ...
              {field:'cjks',title:'状态',sortable:true,width:100,align:'center',
