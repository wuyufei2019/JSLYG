...
$(function(){
    ...
    columns:[[    
  			...
  			{field : 'm6',title : '分类',sortable : false,width : 30},
			{field : 'm1',title : '违法行为',sortable : false,width : 60,align : 'center'},
			...
			{field : 'm7',title : '自由裁量依据',sortable : false,width : 60,align : 'center'}
    ...
    onLoadSuccess: function(){
    	$(this).datagrid("autoMergeCells",['m6']);
    },
...
function del(){
	...
	top.layer.confirm('删除后无法恢复您确定要删除？', {icon: 3, title:'提示'}, function(index){
		$.ajax({
			type:'get',
			url:ctx+"/aqzf/wfxwtwo/delete/"+ids,
...
//添加
function add(u) {
	openDialog("添加自由裁量标准信息",ctx+"/aqzf/wfxwtwo/create/","800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改自由裁量标准信息",ctx+"/aqzf/wfxwtwo/update/"+row.id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看自由裁量标准信息",ctx+"/aqzf/wfxwtwo/view/"+row.id,"800px", "400px","");
}
...
function addcfcl(){
	...
	openDialogView("处罚裁量管理",ctx+"/aqzf/cfcl/index/"+row.id+"?version=2","900px", "400px","");
}
...
function fileexport(){
	...
	layer.open({
        ...
        maxmin: false, 
        shift: 1,
	    content: ctx+'/aqzf/wfxwtwo/colindex',
		btn: ['导出'],
