...
//添加
function add(u) {
	openDialog("添加自由裁量标准信息",ctx+"/aqzf/wfxw/create/","800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改自由裁量标准信息",ctx+"/aqzf/wfxw/update/"+row.id,"800px", "400px","");
...
function view(){
	...
	openDialogView("查看自由裁量标准信息",ctx+"/aqzf/wfxw/view/"+row.id,"800px", "400px","");
}
...
function addcfcl(){
	...
	openDialogView("处罚裁量管理",ctx+"/aqzf/cfcl/index/"+row.id+"?version=1","900px", "400px","");
}
