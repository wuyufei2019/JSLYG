...
//添加检查记录
function addJl(id){
    openDialog("添加检查记录", ctx + "/aqzf/jcjl/addJl/"+id+"/2", "900px","450px", "");
    /*layer.confirm('请选择自由裁量类型', {
        ...
        openDialog("添加检查记录", ctx + "/aqzf/jcjl/addJl/"+id+"/1", "900px","450px", "");
    });*/
}
...
//		return;
//	}else if(row.m11 == '0'){
		openDialog("修改检查方案", ctx + "/aqzf/jcfa/update/" + row.id, "80%",
				"100%", "");
//	}
}
...
function view() {
	...
	openDialogView("查看检查方案",ctx + "/aqzf/jcfa/view/" + row.id,"80%", "100%","");
