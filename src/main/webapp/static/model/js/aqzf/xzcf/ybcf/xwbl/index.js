...
$(function(){
    ...
    columns:[[    
  			...
  			{field : 'labh',title : '立案编号',sortable : false,width : 70},
			{field : 'm8',title : '企业名称',sortable : false,width : 80,align : 'center'},
			{field : 'm0',title : '询问次号',sortable : false,width : 20,align : 'center'},
			{field : 'm16',title : '调查主题',sortable : false,width : 90,align : 'center'},
    ...
    onLoadSuccess: function(){
    	$(this).datagrid("autoMergeCells", [ 'labh' ]);
    },
...
function upd(){
	...
	openDialog("修改询问笔录信息",ctx+"/xzcf/ybcf/xwbl/update/"+row.id,"80%", "100%","");
...
function view(){
	...
	openDialogView("查看询问笔录信息",ctx+"/xzcf/ybcf/xwbl/view/"+row.id,"80%", "100%","");
