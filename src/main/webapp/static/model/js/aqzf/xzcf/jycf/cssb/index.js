...
$(function(){
    ...
    columns:[[    
  			...
  			{field : 'gzbh',title : '立案编号',sortable : false,width : 100},
...
function view(){
	...
	openDialogView("查看陈述申辩笔录信息",ctx+"/xzcf/jycf/cssb/view/"+row.id,"800px", "400px","");
}
...
function upd(){
	...
	openDialog("修改陈述申辩笔录信息",ctx+"/xzcf/jycf/cssb/update/"+row.id,"800px", "400px","");
}
...
function fileexport(){
	...
	$.ajax({
		url:ctx+"/xzcf/jycf/cssb/export/cs/"+row.id,
		type:"POST",
		success:function(data){
