...
var usertype;
$(function () {
    dg = $('#erm_zjk_dg').datagrid({
        method: "post",
        url: ctx + '/erm/zjk/list',
        fit: true,
        fitColumns: true,
        border: false,
        idField: 'id',
        ...
        columns: [[
            ...
            {field: 'm11', title: '联系方式', width: 100, align: 'center'},
            {
            ...
            {field: 'm17', title: '组别', width: 100, align: 'center'},
            {
                field: 'mark', title: '是否为应急专家', width: 100, align: 'center', formatter: function (value, row, index) {
                    if (row.mark == '1') {
                        return '应急专家';
                    } else {
                        return '非应急专家';
...
//弹窗增加
function add(u) {
    openDialog("添加应急专家信息", ctx + "/erm/zjk/create/", "800px", "400px", "");
}
...
function upd() {
    ...
    openDialog("修改应急专家信息", ctx + "/erm/zjk/update/" + row.id, "800px", "400px", "");
...
function view() {
    ...
    openDialogView("查看应急专家信息", ctx + "/erm/zjk/view/" + row.id, "800px", "400px", "");
